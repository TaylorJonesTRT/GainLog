...
class ActiveRecord::Base
  ...
  # source://activerecord/7.1.3.1/lib/active_record/reflection.rb#11
  ...
  # source://activemodel/7.1.3.1/lib/active_model/validations.rb#71
  def _validators; end

  # source://activemodel/7.1.3.1/lib/active_model/validations.rb#71
  def _validators?; end

  # source://activerecord/7.1.3.1/lib/active_record/reflection.rb#12
  ...
  # source://activemodel/7.1.3.1/lib/active_model/attribute_methods.rb#72
  def attribute_aliases; end

  # source://activemodel/7.1.3.1/lib/active_model/attribute_methods.rb#72
  def attribute_aliases?; end

  # source://activemodel/7.1.3.1/lib/active_model/attribute_methods.rb#73
  def attribute_method_patterns; end

  # source://activemodel/7.1.3.1/lib/active_model/attribute_methods.rb#73
  def attribute_method_patterns?; end

  # source://activerecord/7.1.3.1/lib/active_record/reflection.rb#13
  def automatic_scope_inversing; end

  # source://activerecord/7.1.3.1/lib/active_record/reflection.rb#13
  def automatic_scope_inversing?; end

  # source://activerecord/7.1.3.1/lib/active_record/integration.rb#16
  def cache_timestamp_format; end

  # source://activerecord/7.1.3.1/lib/active_record/integration.rb#16
  def cache_timestamp_format?; end

  # source://activerecord/7.1.3.1/lib/active_record/integration.rb#24
  def cache_versioning; end

  # source://activerecord/7.1.3.1/lib/active_record/integration.rb#24
  def cache_versioning?; end

  # source://activerecord/7.1.3.1/lib/active_record/integration.rb#32
  def collection_cache_versioning; end

  # source://activerecord/7.1.3.1/lib/active_record/integration.rb#32
  def collection_cache_versioning?; end

  # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#178
  def column_for_attribute(name, &block); end

  # source://activerecord/7.1.3.1/lib/active_record/core.rb#97
  def default_connection_handler; end

  # source://activerecord/7.1.3.1/lib/active_record/core.rb#97
  def default_connection_handler?; end

  # source://activerecord/7.1.3.1/lib/active_record/core.rb#99
  def default_role; end

  # source://activerecord/7.1.3.1/lib/active_record/core.rb#99
  def default_role?; end

  # source://activerecord/7.1.3.1/lib/active_record/scoping/default.rb#20
  def default_scope_override; end

  # source://activerecord/7.1.3.1/lib/active_record/scoping/default.rb#19
  def default_scopes; end

  # source://activerecord/7.1.3.1/lib/active_record/core.rb#101
  def default_shard; end

  # source://activerecord/7.1.3.1/lib/active_record/core.rb#101
  def default_shard?; end

  # source://activerecord/7.1.3.1/lib/active_record/enum.rb#167
  def defined_enums; end

  # source://activerecord/7.1.3.1/lib/active_record/enum.rb#167
  def defined_enums?; end

  # source://activerecord/7.1.3.1/lib/active_record/core.rb#47
  def destroy_association_async_batch_size; end

  # source://activerecord/7.1.3.1/lib/active_record/core.rb#37
  def destroy_association_async_job(&block); end

  # source://activerecord/7.1.3.1/lib/active_record/encryption/encryptable_record.rb#11
  ...
  # source://activemodel/7.1.3.1/lib/active_model/serializers/json.rb#15
  def include_root_in_json; end

  # source://activemodel/7.1.3.1/lib/active_model/serializers/json.rb#15
  def include_root_in_json?; end

  # source://activerecord/7.1.3.1/lib/active_record/locking/optimistic.rb#56
  def lock_optimistically; end

  # source://activerecord/7.1.3.1/lib/active_record/locking/optimistic.rb#56
  def lock_optimistically?; end

  # source://activerecord/7.1.3.1/lib/active_record/core.rb#22
  def logger; end

  # source://activerecord/7.1.3.1/lib/active_record/core.rb#22
  def logger?; end

  # source://activemodel/7.1.3.1/lib/active_model/naming.rb#255
  def model_name(&block); end

  # source://activerecord/7.1.3.1/lib/active_record/nested_attributes.rb#15
  def nested_attributes_options; end

  # source://activerecord/7.1.3.1/lib/active_record/nested_attributes.rb#15
  def nested_attributes_options?; end

  # source://activerecord/7.1.3.1/lib/active_record/normalization.rb#8
  ...
  # source://activemodel/7.1.3.1/lib/active_model/conversion.rb#32
  def param_delimiter=(_arg0); end

  # source://activerecord/7.1.3.1/lib/active_record/attribute_methods/dirty.rb#50
  def partial_inserts; end

  # source://activerecord/7.1.3.1/lib/active_record/attribute_methods/dirty.rb#50
  def partial_inserts?; end

  # source://activerecord/7.1.3.1/lib/active_record/attribute_methods/dirty.rb#49
  def partial_updates; end

  # source://activerecord/7.1.3.1/lib/active_record/attribute_methods/dirty.rb#49
  def partial_updates?; end

  # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#163
  def pluralize_table_names; end

  # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#163
  def pluralize_table_names?; end

  # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#158
  def primary_key_prefix_type; end

  # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#158
  def primary_key_prefix_type?; end

  # source://activerecord/7.1.3.1/lib/active_record/timestamp.rb#47
  ...
  # source://activerecord/7.1.3.1/lib/active_record/signed_id.rb#13
  def signed_id_verifier_secret; end

  # source://activerecord/7.1.3.1/lib/active_record/signed_id.rb#13
  def signed_id_verifier_secret?; end

  # source://activerecord/7.1.3.1/lib/active_record/attribute_methods/time_zone_conversion.rb#67
  def skip_time_zone_conversion_for_attributes; end

  # source://activerecord/7.1.3.1/lib/active_record/attribute_methods/time_zone_conversion.rb#67
  def skip_time_zone_conversion_for_attributes?; end

  # source://activerecord/7.1.3.1/lib/active_record/inheritance.rb#43
  def store_full_class_name; end

  # source://activerecord/7.1.3.1/lib/active_record/inheritance.rb#43
  def store_full_class_name?; end

  # source://activerecord/7.1.3.1/lib/active_record/inheritance.rb#47
  def store_full_sti_class; end

  # source://activerecord/7.1.3.1/lib/active_record/inheritance.rb#47
  def store_full_sti_class?; end

  # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#159
  def table_name_prefix; end

  # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#159
  def table_name_prefix?; end

  # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#160
  def table_name_suffix; end

  # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#160
  def table_name_suffix?; end

  # source://activerecord/7.1.3.1/lib/active_record/attribute_methods/time_zone_conversion.rb#66
  def time_zone_aware_attributes; end

  # source://activerecord/7.1.3.1/lib/active_record/attribute_methods/time_zone_conversion.rb#66
  def time_zone_aware_attributes?; end

  # source://activerecord/7.1.3.1/lib/active_record/attribute_methods/time_zone_conversion.rb#68
  ...
  # source://activemodel/7.1.3.1/lib/active_model/validations.rb#67
  ...
  class << self
    ...
    # source://activerecord/7.1.3.1/lib/active_record/readonly_attributes.rb#11
    ...
    # source://activerecord/7.1.3.1/lib/active_record/counter_cache.rb#9
    ...
    # source://activerecord/7.1.3.1/lib/active_record/core.rb#24
    ...
    # source://activemodel/7.1.3.1/lib/active_model/callbacks.rb#144
    ...
    # source://activerecord/7.1.3.1/lib/active_record/core.rb#105
    def application_record_class?; end

    # source://activemodel/7.1.3.1/lib/active_model/callbacks.rb#137
    ...
    # source://activerecord/7.1.3.1/lib/active_record/core.rb#125
    def asynchronous_queries_session; end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#129
    ...
    # source://activerecord/7.1.3.1/lib/active_record/attributes.rb#11
    ...
    # source://activemodel/7.1.3.1/lib/active_model/callbacks.rb#130
    ...
    # source://activerecord/7.1.3.1/lib/active_record/core.rb#89
    ...
    # source://activerecord/7.1.3.1/lib/active_record/core.rb#77
    def configurations; end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#71
    def configurations=(config); end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#189
    def connected_to_stack; end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#203
    def connection_class; end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#199
    def connection_class=(b); end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#207
    def connection_class?; end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#211
    def connection_class_for_self; end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#117
    def connection_handler; end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#121
    def connection_handler=(handler); end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#180
    def current_preventing_writes; end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#143
    def current_role; end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#161
    def current_shard; end

    # source://activerecord/7.1.3.1/lib/active_record/attribute_methods/serialization.rb#20
    ...
    # source://activerecord/7.1.3.1/lib/active_record/core.rb#27
    ...
    # source://activerecord/7.1.3.1/lib/active_record/core.rb#87
    ...
    # source://activerecord/7.1.3.1/lib/active_record/token_for.rb#11
    def generated_token_verifier; end

    # source://activerecord/7.1.3.1/lib/active_record/token_for.rb#11
    def generated_token_verifier=(value); end

    # source://activerecord/7.1.3.1/lib/active_record/core.rb#93
    ...
    # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#165
    ...
    # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#164
    ...
    # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#167
    def inheritance_column; end

    # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#321
    def inheritance_column=(value); end

    # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#167
    def inheritance_column?; end

    # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#162
    ...
    # source://activerecord/7.1.3.1/lib/active_record/store.rb#101
    ...
    # source://activerecord/7.1.3.1/lib/active_record/core.rb#95
    ...
    # source://activerecord/7.1.3.1/lib/active_record/model_schema.rb#161
    ...
    # source://activerecord/7.1.3.1/lib/active_record/core.rb#103
    ...
    # source://activerecord/7.1.3.1/lib/active_record/core.rb#91
    ...
    # source://activerecord/7.1.3.1/lib/active_record/core.rb#226
    ...
    # source://activerecord/7.1.3.1/lib/active_record/token_for.rb#10
...
module ActiveStorage
  ...
  class << self
    ...
    # source://railties/7.1.3.1/lib/rails/engine.rb#412
    def railtie_helpers_paths; end

    # source://railties/7.1.3.1/lib/rails/engine.rb#395
    def railtie_namespace; end

    # source://railties/7.1.3.1/lib/rails/engine.rb#416
    ...
    # source://railties/7.1.3.1/lib/rails/engine.rb#401
    def table_name_prefix; end
    ...
    # source://railties/7.1.3.1/lib/rails/engine.rb#408
...
class ActiveStorage::AnalyzeJob < ::ActiveStorage::BaseJob
  ...
  class << self
    # source://activejob/7.1.3.1/lib/active_job/queue_name.rb#55
    def queue_name; end

    # source://activesupport/7.1.3.1/lib/active_support/rescuable.rb#15
...
class ActiveStorage::Attached::Many < ::ActiveStorage::Attached
  ...
  # source://activesupport/7.1.3.1/lib/active_support/core_ext/module/delegation.rb#331
  ...
  # source://activesupport/7.1.3.1/lib/active_support/core_ext/module/delegation.rb#323
...
class ActiveStorage::Attachment < ::ActiveStorage::Record
  ...
  # source://activerecord/7.1.3.1/lib/active_record/autosave_association.rb#160
  ...
  class << self
    ...
    # source://activerecord/7.1.3.1/lib/active_record/scoping/named.rb#174
    def with_all_variant_records(*args, **_arg1); end
  end
end

module ActiveStorage::Attachment::GeneratedAssociationMethods
  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/association.rb#103
  def blob; end

  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/association.rb#111
  def blob=(value); end

  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/belongs_to.rb#145
  def blob_changed?; end

  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/belongs_to.rb#149
  def blob_previously_changed?; end

  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/singular_association.rb#32
  def build_blob(*args, &block); end

  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/singular_association.rb#36
  def create_blob(*args, &block); end

  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/singular_association.rb#40
  def create_blob!(*args, &block); end
  ...
  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/singular_association.rb#19
  def reload_blob; end

  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/singular_association.rb#19
  def reload_record; end

  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/singular_association.rb#23
  def reset_blob; end
...
class ActiveStorage::BaseController < ::ActionController::Base
  ...
  # source://actionview/7.1.3.1/lib/action_view/layouts.rb#330
  ...
  class << self
    ...
    # source://actionpack/7.1.3.1/lib/action_controller/metal/etag_with_template_digest.rb#29
    def etag_with_template_digest; end

    # source://actionpack/7.1.3.1/lib/action_controller/metal.rb#262
...
class ActiveStorage::Blob < ::ActiveStorage::Record
  ...
  # source://actiontext/7.1.3.1/lib/action_text/engine.rb#47
  ...
  # source://actiontext/7.1.3.1/lib/action_text/engine.rb#43
  def previewable_attachable?; end

  def purge; end
  def purge_later; end

  # source://activerecord/7.1.3.1/lib/active_record/secure_token.rb#53
  ...
  # source://actiontext/7.1.3.1/lib/action_text/engine.rb#51
...
module ActiveStorage::Blob::GeneratedAssociationMethods
  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/collection_association.rb#62
  def attachment_ids; end

  # source://activerecord/7.1.3.1/lib/active_record/associations/builder/collection_association.rb#72
...
class ActiveStorage::Current < ::ActiveSupport::CurrentAttributes
  class << self
    # source://activesupport/7.1.3.1/lib/active_support/current_attributes.rb#127
    def url_options; end
...
class ActiveStorage::FixtureSet
  ...
  # source://activesupport/7.1.3.1/lib/active_support/testing/file_fixtures.rb#20
...
class ActiveStorage::LogSubscriber < ::ActiveSupport::LogSubscriber
  ...
  class << self
    # source://activesupport/7.1.3.1/lib/active_support/log_subscriber.rb#87
    def log_levels; end
  end
end
