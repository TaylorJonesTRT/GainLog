...
class ActionController::Base < ::ActionController::Metal
  ...
  # source://actionpack/7.1.3.1/lib/abstract_controller/helpers.rb#12
  ...
  # source://actionview/7.1.3.1/lib/action_view/layouts.rb#216
  def _layout_conditions(&block); end

  # source://activesupport/7.1.3.1/lib/active_support/callbacks.rb#963
  def _process_action_callbacks; end

  # source://actionpack/7.1.3.1/lib/action_controller/metal/renderers.rb#31
  def _renderers; end
  ...
  # source://actionpack/7.1.3.1/lib/abstract_controller/caching.rb#42
  ...
  # source://actionpack/7.1.3.1/lib/action_controller/metal/params_wrapper.rb#187
  ...
  # source://actionpack/7.1.3.1/lib/action_controller/metal/flash.rb#36
  def alert; end
  ...
  # source://actionpack/7.1.3.1/lib/action_controller/metal/conditional_get.rb#13
  def etaggers; end
  ...
  # source://actionpack/7.1.3.1/lib/action_controller/metal/flash.rb#10
  ...
  # source://actionpack/7.1.3.1/lib/abstract_controller/caching/fragments.rb#25
  ...
  # source://actionpack/7.1.3.1/lib/action_controller/metal/helpers.rb#65
  ...
  # source://actionpack/7.1.3.1/lib/action_controller/metal/helpers.rb#66
  ...
  # source://actionpack/7.1.3.1/lib/abstract_controller/callbacks.rb#36
  ...
  # source://actionpack/7.1.3.1/lib/action_controller/base.rb#252
  ...
  class << self
    ...
    # source://actionpack/7.1.3.1/lib/action_controller/form_builder.rb#33
    ...
    # source://actionpack/7.1.3.1/lib/action_controller/metal/flash.rb#8
    ...
    # source://actionpack/7.1.3.1/lib/abstract_controller/helpers.rb#16
    def _helpers; end

    # source://actionview/7.1.3.1/lib/action_view/layouts.rb#211
    def _layout; end
    ...
    # source://actionview/7.1.3.1/lib/action_view/layouts.rb#212
    ...
    # source://actionpack/7.1.3.1/lib/action_controller/base.rb#184
...
module ActionController::Base::HelperMethods
  ...
  # source://actionpack/7.1.3.1/lib/action_controller/metal/flash.rb#39
  def alert(*args, **_arg1, &block); end

  # source://actionpack/7.1.3.1/lib/abstract_controller/caching/fragments.rb#33
  def combined_fragment_cache_key(*args, **_arg1, &block); end

  # source://actionpack/7.1.3.1/lib/action_controller/metal/content_security_policy.rb#11
  def content_security_policy?(*args, **_arg1, &block); end

  # source://actionpack/7.1.3.1/lib/action_controller/metal/content_security_policy.rb#12
  def content_security_policy_nonce(*args, **_arg1, &block); end

  # source://actionpack/7.1.3.1/lib/action_controller/metal/cookies.rb#8
  ...
  # source://actionpack/7.1.3.1/lib/action_controller/metal/request_forgery_protection.rb#101
  def form_authenticity_token(*args, **_arg1, &block); end

  # source://actionpack/7.1.3.1/lib/action_controller/metal/flash.rb#39
  def notice(*args, **_arg1, &block); end

  # source://actionpack/7.1.3.1/lib/action_controller/metal/request_forgery_protection.rb#102
  ...
  # source://actionpack/7.1.3.1/lib/abstract_controller/caching.rb#43
