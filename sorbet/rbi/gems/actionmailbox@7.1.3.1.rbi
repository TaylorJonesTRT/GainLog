...
class ActionMailbox::InboundEmail < ::ActionMailbox::Record
  ...
  class << self
    ...
    # source://activerecord/7.1.3.1/lib/active_record/enum.rb#242
    def statuses; end
...
module ActionMailbox::InboundEmail::GeneratedAssociationMethods
  ...
  # source://activestorage/7.1.3.1/lib/active_storage/attached/model.rb#99
  def raw_email; end

  # source://activestorage/7.1.3.1/lib/active_storage/attached/model.rb#104
